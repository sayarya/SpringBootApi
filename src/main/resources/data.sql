...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'C1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Ward'), '2020-01-02');
